/**
 * Structured Data Helpers — personal-portfolio-001
 * Import and use in your SEO.jsx component
 */

export const SITE_URL = 'https://personal-portfolio-001.com';
export const SITE_NAME = 'personal-portfolio-001';
export const INDUSTRY = 'fintech';
